...
int main(int argc, char **argv) {
    ...
    struct { const char *name; qwasar_chat_options o; int n; qwasar_message m[4]; } chats[] = {
        { "simple", { true, "xhigh", true, NULL, 0, false }, 1,
          { { "user", "What is 2+2?", NULL, NULL } } },
        { "with_system", { true, "xhigh", true, NULL, 0, false }, 2,
          { { "system", "You are terse.", NULL, NULL }, { "user", "Hi", NULL, NULL } } },
        { "no_thinking", { false, "xhigh", true, NULL, 0, false }, 1,
          { { "user", "Hi", NULL, NULL } } },
        { "low_effort", { true, "low", true, NULL, 0, false }, 1,
          { { "user", "Hi", NULL, NULL } } },
        { "medium_effort", { true, "medium", true, NULL, 0, false }, 1,
          { { "user", "Hi", NULL, NULL } } },
        { "with_tools", { true, "xhigh", true, TOOLS, 2, false }, 1,
          { { "user", "Read /tmp/a.txt", NULL, NULL } } },
        { "tools_and_system", { true, "xhigh", true, TOOLS, 2, false }, 2,
          { { "system", "Be careful.", NULL, NULL }, { "user", "Read /tmp/a.txt", NULL, NULL } } },
        { "multi_turn", { true, "xhigh", true, NULL, 0, false }, 3,
