...
| — | escalation E1+E2: `delegate`, budgeted, embedded, steerable; the remote agent drives the sandbox by proxy (§15) |
...
- **§15 — escalation.** E1 and E2 built; next E3 (judgment: prompt-fragment
